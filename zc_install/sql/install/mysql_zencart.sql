...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('Re-calculate Tax', 'MODULE_ORDER_TOTAL_GV_CALC_TAX', 'tax_incl', 'GV amount is applied on subtotal tax included -> tax_incl (default), if applied on subtotal without tax -> tax_excl', 6, 7, NULL, '2003-10-30 22:16:40', NULL, 'zen_cfg_select_option([\'tax_incl\', \'tax_excl\'],');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('Re-calculate Tax', 'MODULE_ORDER_TOTAL_COUPON_CALC_TAX', 'tax_incl', 'Discount coupon amount is applied on subtotal tax included -> tax_incl (default), if applied on subtotal without tax -> tax_excl', 6, 7, NULL, '2003-10-30 22:16:36', NULL, 'zen_cfg_select_option([\'tax_incl\', \'tax_excl\'],');
