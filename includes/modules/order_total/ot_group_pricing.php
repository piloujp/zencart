...
class ot_group_pricing {
  ...
  function get_order_total() {
    ...
    $order_total -= zen_config('DISPLAY_PRICE_WITH_TAX') !== 'true' ? $order->info['tax'] : 0;
  ...
  function calculate_deductions($order_total) {
    ...
    if ($group_query->fields['customers_group_pricing'] != '0') {
        ...
        $od_amount['total'] = ($orderTotal['total'] - $gift_vouchers) * $group_discount->fields['group_percentage'] / 100;
